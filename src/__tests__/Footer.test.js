...
describe('Test Footer component', () => {
    it('Render component first time', () => {
        ...
        render(<Footer page={1} getNextPage={mockCallbackNext} getPreviousPage={mockCallbackPrev}/>)
    ...
    it('Render component second time', () => {
        ...
        render(<Footer page={2} getNextPage={mockCallbackNext} getPreviousPage={mockCallbackPrev}/>)
